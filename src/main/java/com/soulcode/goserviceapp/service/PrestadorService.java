...
public class PrestadorService {
    ...
    @Autowired
    private PrestadorRepository prestadorRespository;

    public Prestador findById(Long id){
        Optional<Prestador> prestador = prestadorRespository.findById(id);
    ...
    public Prestador update(Prestador prestador){
        ...
        updatePrestador.setTaxaPorHora(updatePrestador.getTaxaPorHora());
        return prestadorRespository.save(updatePrestador);
    }
